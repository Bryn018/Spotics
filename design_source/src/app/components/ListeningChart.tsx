            ...
            <AreaChart data={data} id={`listening-chart-${uniqueId}`}>
              <defs>
                <linearGradient id={`listeningChartGradient-${uniqueId}`} x1="0" y1="0" x2="0" y2="1">
                  <stop key="stop1" offset="0%" stopColor="#a855f7" stopOpacity={0.9}/>
                  <stop key="stop2" offset="50%" stopColor="#ec4899" stopOpacity={0.4}/>
                  <stop key="stop3" offset="100%" stopColor="#ec4899" stopOpacity={0}/>
                </linearGradient>
